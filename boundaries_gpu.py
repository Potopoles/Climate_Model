...
def exchange_BC_gpu(GR, FIELD, zonald, meridd, stream):
    get_BCx[GR.griddim, GR.blockdim, stream](FIELD, zonald)
    stream.synchronize()
    set_BCx[GR.griddim, GR.blockdim, stream](FIELD, zonald)
    stream.synchronize()
    get_BCy[GR.griddim, GR.blockdim, stream](FIELD, meridd)
    stream.synchronize()
    set_BCy[GR.griddim, GR.blockdim, stream](FIELD, meridd)
    stream.synchronize()
    return(FIELD)
...
#def exchange_BC_gpu(GR, FIELD, zonald, meridd, stream):
#    get_BC[GR.griddim, GR.blockdim, stream](FIELD, zonald, meridd)
#    stream.synchronize()
#    set_BC[GR.griddim, GR.blockdim, stream](FIELD, zonald, meridd)
#    stream.synchronize()
#    return(FIELD)
